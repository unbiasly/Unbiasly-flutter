...
FeedActionResponse _$FeedActionResponseFromJson(Map<String, dynamic> json) {
  return _FeedActionResponse.fromJson(json);
}

/// @nodoc
mixin _$FeedActionResponse {
  @JsonKey(name: "articleAction")
  List<ArticleAction>? get articleAction => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $FeedActionResponseCopyWith<FeedActionResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FeedActionResponseCopyWith<$Res> {
  factory $FeedActionResponseCopyWith(
          FeedActionResponse value, $Res Function(FeedActionResponse) then) =
      _$FeedActionResponseCopyWithImpl<$Res, FeedActionResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$FeedActionResponseCopyWithImpl<$Res, $Val extends FeedActionResponse>
    implements $FeedActionResponseCopyWith<$Res> {
  _$FeedActionResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$FeedActionResponseImplCopyWith<$Res>
    implements $FeedActionResponseCopyWith<$Res> {
  factory _$$FeedActionResponseImplCopyWith(_$FeedActionResponseImpl value,
          $Res Function(_$FeedActionResponseImpl) then) =
      __$$FeedActionResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "articleAction") List<ArticleAction>? articleAction});
...
/// @nodoc
class __$$FeedActionResponseImplCopyWithImpl<$Res>
    extends _$FeedActionResponseCopyWithImpl<$Res, _$FeedActionResponseImpl>
    implements _$$FeedActionResponseImplCopyWith<$Res> {
  __$$FeedActionResponseImplCopyWithImpl(_$FeedActionResponseImpl _value,
      $Res Function(_$FeedActionResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$FeedActionResponseImpl(
      articleAction: freezed == articleAction
...
/// @nodoc
@JsonSerializable()
class _$FeedActionResponseImpl implements _FeedActionResponse {
  const _$FeedActionResponseImpl(
      {@JsonKey(name: "articleAction")
      final List<ArticleAction>? articleAction})
      : _articleAction = articleAction;

  factory _$FeedActionResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$FeedActionResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'FeedActionResponse(articleAction: $articleAction)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$FeedActionResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$FeedActionResponseImplCopyWith<_$FeedActionResponseImpl> get copyWith =>
      __$$FeedActionResponseImplCopyWithImpl<_$FeedActionResponseImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$FeedActionResponseImplToJson(
      this,
    );
  }
}

abstract class _FeedActionResponse implements FeedActionResponse {
  const factory _FeedActionResponse(
      {@JsonKey(name: "articleAction")
      final List<ArticleAction>? articleAction}) = _$FeedActionResponseImpl;

  factory _FeedActionResponse.fromJson(Map<String, dynamic> json) =
      _$FeedActionResponseImpl.fromJson;
...
mixin _$ArticleAction {
  ...
  ArticleId? get articleId => throw _privateConstructorUsedError;
...
abstract class $ArticleActionCopyWith<$Res> {
  ...
  $ArticleIdCopyWith<$Res>? get articleId;
}
...
class _$ArticleActionCopyWithImpl<$Res, $Val extends ArticleAction>
  ...
  @pragma('vm:prefer-inline')
  $ArticleIdCopyWith<$Res>? get articleId {
    if (_value.articleId == null) {
      return null;
    }

    return $ArticleIdCopyWith<$Res>(_value.articleId!, (value) {
      return _then(_value.copyWith(articleId: value) as $Val);
    });
  }
}
...
class _$ArticleActionImpl implements _ArticleAction {
  ...
  @override
  String toString() {
    return 'ArticleAction(isLiked: $isLiked, isDisliked: $isDisliked, isBookmarked: $isBookmarked, isViewed: $isViewed, isShared: $isShared, sharedCount: $sharedCount, id: $id, userId: $userId, articleId: $articleId, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }
...
abstract class _ArticleAction implements ArticleAction {
  const factory _ArticleAction(
      ...
      @JsonKey(name: "article_id") final ArticleId? articleId,
...
ArticleId _$ArticleIdFromJson(Map<String, dynamic> json) {
  return _ArticleId.fromJson(json);
}
...
mixin _$ArticleId {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $ArticleIdCopyWith<ArticleId> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ArticleIdCopyWith<$Res> {
  factory $ArticleIdCopyWith(ArticleId value, $Res Function(ArticleId) then) =
      _$ArticleIdCopyWithImpl<$Res, ArticleId>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ArticleIdCopyWithImpl<$Res, $Val extends ArticleId>
    implements $ArticleIdCopyWith<$Res> {
  _$ArticleIdCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ArticleIdImplCopyWith<$Res>
    implements $ArticleIdCopyWith<$Res> {
  factory _$$ArticleIdImplCopyWith(
          _$ArticleIdImpl value, $Res Function(_$ArticleIdImpl) then) =
      __$$ArticleIdImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "date") DateTime? date,
...
/// @nodoc
class __$$ArticleIdImplCopyWithImpl<$Res>
    extends _$ArticleIdCopyWithImpl<$Res, _$ArticleIdImpl>
    implements _$$ArticleIdImplCopyWith<$Res> {
  __$$ArticleIdImplCopyWithImpl(
      _$ArticleIdImpl _value, $Res Function(_$ArticleIdImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$ArticleIdImpl implements _ArticleId {
  const _$ArticleIdImpl(
  ...
  factory _$ArticleIdImpl.fromJson(Map<String, dynamic> json) =>
      _$$ArticleIdImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ArticleId(date: $date, likes: $likes, dislikes: $dislikes, views: $views, bookmarks: $bookmarks, share: $share, category: $category, tags: $tags, isDeleted: $isDeleted, status: $status, id: $id, articleId: $articleId, title: $title, body: $body, bodyShort: $bodyShort, source: $source, thumbnailUrl: $thumbnailUrl, thumbnailType: $thumbnailType, language: $language, authorName: $authorName, link: $link, ownCategories: $ownCategories, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ArticleIdImplCopyWith<_$ArticleIdImpl> get copyWith =>
      __$$ArticleIdImplCopyWithImpl<_$ArticleIdImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ArticleIdImplToJson(
      this,
    );
  }
}

abstract class _ArticleId implements ArticleId {
  const factory _ArticleId(
      ...
      @JsonKey(name: "createdAt") final DateTime? createdAt,
      @JsonKey(name: "updatedAt") final DateTime? updatedAt,
      @JsonKey(name: "__v") final int? v}) = _$ArticleIdImpl;

  factory _ArticleId.fromJson(Map<String, dynamic> json) =
      _$ArticleIdImpl.fromJson;
...
class _$CategoryImpl implements _Category {
  ...
  @override
  String toString() {
    return 'Category(id: $id, slug: $slug, name: $name, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, slug, name, createdAt, updatedAt, v);
...
class _$SourceImpl implements _Source {
  ...
  @override
  String toString() {
    return 'Source(sourcePriority: $sourcePriority, status: $status, id: $id, sourceId: $sourceId, sourceUrl: $sourceUrl, sourceIcon: $sourceIcon, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, sourcePriority, status, id,
      sourceId, sourceUrl, sourceIcon, createdAt, updatedAt, v);
